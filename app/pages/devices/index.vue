...
const handleDelete = async (id: string) => {
  if (!confirm('Are you sure you want to delete this device? Sensors mapped to this device may lose their link.')) return
  try {
...
<template>
  <div class="flex flex-col gap-6">
    <div class="flex items-center justify-between">
      <div>
        <h2 class="text-2xl font-bold tracking-tight text-slate-800 dark:text-white">Master Devices</h2>
    ...
    <!-- Table list -->
    <UiTable :headers="headers" :items="deviceTypes" :loading="pending" empty-text="No master devices found.">
