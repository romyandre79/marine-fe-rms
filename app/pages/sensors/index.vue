...
const sensors = computed(() => devicesRes.value?.data || [])
...
<template>
  <div class="flex flex-col gap-6">
    <div class="flex items-center justify-between">
      <div>
        <h2 class="text-2xl font-bold tracking-tight text-slate-800 dark:text-white">Registered Sensors</h2>
    ...
    <!-- Table list -->
    <UiTable :headers="headers" :items="sensors" :loading="pending" empty-text="No registered sensors found.">
    ...
    <UiModal
      v-model="isModalOpen"
      :title="isEditMode ? 'Edit Sensor Node' : 'Register New Sensor'"
      size="md"
    >
      ...
      <form @submit.prevent="handleSubmit" class="flex flex-col gap-4">
        ...
        <div class="flex flex-col gap-1.5">
          <label class="text-xs font-semibold text-slate-500">Device Category</label>
          <select
